...
switch (uname)
    ...
    case Darwin
        ...
        #set -gx PATH $PATH $HOME/chromium/depot_tools
...
function do-backup
    sudo cp -r $HOME /mnt/data/backup
end
...
# Added by Windsurf
fish_add_path /Users/jaeyong/.codeium/windsurf/bin

# The next line updates PATH for the Google Cloud SDK.
if [ -f '/Users/jaeyong/google-cloud-sdk/path.fish.inc' ]
    . '/Users/jaeyong/google-cloud-sdk/path.fish.inc'
end
...
alias claude="/Users/jaeyong/.claude/local/claude"

# Added by LM Studio CLI (lms)
set -gx PATH $PATH /Users/jaeyong/.lmstudio/bin
